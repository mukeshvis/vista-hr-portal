...
export function generateLeaveApplicationEmail(
  data: LeaveApplicationData,
  recipientRole: 'manager' | 'hr',
  baseUrl: string
) {
  const approveUrl = `${baseUrl}/api/leaves/email-approval?token=${data.approvalToken}&action=approve&role=${recipientRole}`
  const rejectUrl = `${baseUrl}/api/leaves/email-approval?token=${data.approvalToken}&action=reject&role=${recipientRole}`
...
<head>
  ...
  <title>Leave Application - ${data.employeeName}</title>
</head>
        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;">Leave Application</h1>
              <p style="margin: 10px 0 0; color: #e0e7ff; font-size: 14px;">New leave request requires your attention</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <div style="background-color: #f9fafb; border-left: 4px solid #667eea; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
              ...
              <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
                <h2 style="margin: 0 0 15px; color: #111827; font-size: 18px; font-weight: 600;">Leave Details</h2>
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                  <tr>
                    <td style="padding: 8px 0; color: #92400e; font-size: 14px; width: 40%;">Leave Type:</td>
                    <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">${data.leaveType}</td>
                  </tr>
                  <tr>
                    <td style="padding: 8px 0; color: #92400e; font-size: 14px;">From Date:</td>
                    <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">${data.fromDate}</td>
                  </tr>
                  <tr>
                    <td style="padding: 8px 0; color: #92400e; font-size: 14px;">To Date:</td>
                    <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">${data.toDate}</td>
                  </tr>
                  <tr>
                    <td style="padding: 8px 0; color: #92400e; font-size: 14px;">Number of Days:</td>
              ...
              <!-- Reason Card -->
              <div style="background-color: #ede9fe; border-left: 4px solid #8b5cf6; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
                <h2 style="margin: 0 0 10px; color: #111827; font-size: 18px; font-weight: 600;">Reason</h2>
                <p style="margin: 0; color: #5b21b6; font-size: 14px; line-height: 1.6;">${data.reason || 'No reason provided'}</p>
              </div>

              <!-- Action Buttons -->
              <div style="text-align: center; margin: 40px 0 30px;">
                <p style="margin: 0 0 20px; color: #6b7280; font-size: 14px;">Click below to approve or reject this leave application:</p>
              ...
              <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb;">
                <p style="margin: 0; color: #9ca3af; font-size: 13px; line-height: 1.6; text-align: center;">
                  You can also manage leave applications by logging into the HR Portal.<br>
        ...
        <table role="presentation" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: ${statusColor}; padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;">${statusIcon} Leave ${statusText}</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px; color: #6b7280; font-size: 15px; line-height: 1.6;">
                Your leave application has been <strong style="color: ${statusColor};">${statusText.toLowerCase()}</strong> by ${data.role}.
              </p>
              ...
              <div style="background-color: #f9fafb; border-left: 4px solid ${statusColor}; padding: 20px; margin-bottom: 30px; border-radius: 8px;">
                ...
                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                  <tr>
                    <td style="padding: 8px 0; color: #6b7280; font-size: 14px; width: 40%;">Leave Type:</td>
                    <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">${data.leaveType}</td>
                  </tr>
                  <tr>
                    <td style="padding: 8px 0; color: #6b7280; font-size: 14px;">From Date:</td>
                    <td style="padding: 8px 0; color: #111827; font-size: 14px; font-weight: 600;">${data.fromDate}</td>
                  </tr>
                  <tr>
