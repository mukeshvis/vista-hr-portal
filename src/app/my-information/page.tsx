...
export default function MyInformationPage() {
  ...
  // Redirect admin to employees page
  useEffect(() => {
  ...
  useEffect(() => {
    if (status === 'authenticated' && session?.user?.emp_id && !isAdmin) {
  ...
  }, [status, session?.user?.emp_id, isAdmin])
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <main className="container mx-auto px-6 py-6">
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              <h2 className="text-2xl font-bold mb-2">Information Not Available</h2>
